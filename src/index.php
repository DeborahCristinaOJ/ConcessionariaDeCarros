...
<body>
    ...
    <div class="carousel-inner">
        ...
        <img src="../public/img/BannerPrincipal/Banner2.png" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
        <img src="../public/img/BannerPrincipal/Banner1.png" class="d-block w-100" alt="...">
        </div>
    ...
    <h3>Depoimentos</h3>
    <p>
        "Estou extremamente satisfeito com a Komainu! Encontrei o carro dos meus sonhos e a equipe foi incrivelmente prestativa 
        durante todo o processo. A qualidade e a sofisticação dos veículos que eles oferecem realmente se destacam. 
        Recomendo a Komainu a todos os entusiastas de carros de luxo!"
    </p>
    </div>
