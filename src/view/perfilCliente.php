...
<head>
    ...
    <link rel="stylesheet" href="/ConcessionariaDeCarros-main/public/css/perfilCliente.css?=1234">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/ConcessionariaDeCarros-main/src/view/login.php">Login | Cadastro</a>
                    </li>
                    <li class="nav-item">
